...
>
  {/* Imagen fija de la botella (única y animada) */}
  <motion.div
    style={{ rotate, y, scale, opacity }}

    className="fixed left-4 sm:left-8 md:left-16 lg:left-24 top-1/4 -translate-y-1/2 pointer-events-none z-[40]"
  >
    <Image
      src="/images/maquetai2.png"
      alt="Cerveza"
      width={420}
      height={420}
      priority
    ...
    {beers.map((beer, i) => (
      ...
      >
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-4 items-center">
          {/* Imagen — reemplazada por espacio vacío */}
          <div className="order-1 justify-self-center relative">
            <div
              className="absolute -inset-6 -z-10 blur-3xl rounded-full"
            
            />
            <div className="w-[260px] md:w-[320px] lg:w-[380px] aspect-[2/5]" />
          </div>
          ...
          <div className="order-2">
            <Card className="bg-[#ffffff]/20 border-0 shadow-xl drop-shadow-[0_25px_35px_rgba(255,255,255,0.45)]">
              <CardContent className="p-8">
                ...
                <p className="text-white/85 mb-6 text-2xl tracking-wide">
                  {beer.description}
                </p>
